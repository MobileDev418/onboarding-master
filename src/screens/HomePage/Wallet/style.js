...
export default StyleSheet.create({
  ...
  titleSlide1: {
    marginTop:
      WindowHeight <= iphone5s ? 125 : WindowHeight <= android ? 120 : 149,
  ...
  emojiGroup: {
    ...
    position: "absolute",
    bottom:
      WindowHeight >= iphone7plus ? 110 : WindowHeight <= android ? 70 : 90
  ...
  giftImg: {
    marginTop:
      WindowHeight <= iphone5s ? 30 : WindowHeight <= android ? 43 : 63,
    alignSelf: "center",
    height: 160,
    width: 190
  },
  manImg: {
    marginTop:
      WindowHeight <= iphone5s ? 25 : WindowHeight <= android ? 38 : 54,
    alignSelf: "center",
    height: 150,
    width: 130
  },
  ...
  baseLine: {
    marginTop:
      WindowHeight <= iphone5s ? 30 : WindowHeight <= android ? 45 : 50,
    color: "#9B9B9B",
    fontFamily: "Lato-Regular",
  ...
  inviteFreinds: {
    position: "absolute",
    bottom:
      WindowHeight >= iphone7plus ? 50 : WindowHeight <= android ? 10 : 30,
    marginHorizontal: 73,
    height: 60,
    width: 189,
    justifyContent: "center",
